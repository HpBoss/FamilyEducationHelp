...
public class MyAccountActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ListView的适配
        RecyclerView recyclerView = findViewById(R.id.myAccount_RecyclerView);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.addItemDecoration(new DividerItemDecoration(this,DividerItemDecoration.VERTICAL));//给每一个item添加分割线
    ...
    private void init_myAccount_information() {
        ...
        //判断是否已经把初始数据保存在了数据库
        MyAccountInformation myAccountAdapterUserName;
        MyAccountInformation myAccountAdapterPassWord;
        MyAccountInformation myAccountAdapterPhone;
        MyAccountInformation myAccountAdapterAddress;
        if (myAccountInformationList.size() == 0){
            ...
            if (bitmap != null) {
                ...
                myAccountAdapterIcon = new MyAccountInformation("头像","", R.drawable.un_login_header, R.drawable.next);
                myAccountInformationList.add(myAccountAdapterIcon);
                myAccountAdapterIcon.save();
            }
    ...
    public void initIconData(){
        ...
        if (bitmap != null) {
            ...
            MyAccountInformation myAccountAdapterIcon_temp = new MyAccountInformation("头像","", R.drawable.un_login_header, R.drawable.next);
            myAccountAdapterIcon = myAccountAdapterIcon_temp;
            myAccountInformationList.set(0,myAccountAdapterIcon);
            myAccountAdapterIcon.update(1);
        }
    ...
    private void initData() {
        ...
        ImageView myAccount_back = findViewById(R.id.image_back);
        //设置性别选择器的内容
    ...
    public void showSexDialog(){
        sexDialog = new MyWheelPickerDialog(MyAccountActivity.this,
                R.layout.activity_myaccount_sex_dialog, R.id.sexWheelPicker,R.id.sexConfirm);
    ...
    public void showIdentityDialog(){
        identityDialog = new MyWheelPickerDialog(MyAccountActivity.this,
                R.layout.activity_myaccount_identity_dialog, R.id.identityWheelPicker,R.id.gradeWheelPicker,R.id.identityConfirm);
        //得到WheelPicker对象
    ...
    public void showIconDialog(){
        iconDialog = new MyWheelPickerDialog(MyAccountActivity.this,R.layout.activity_myaccount_icon_dialog,
